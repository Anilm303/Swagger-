...
PRODUCTION_HTTPS = IS_VERCEL and not DEBUG
SESSION_COOKIE_SECURE = PRODUCTION_HTTPS
CSRF_COOKIE_SECURE = PRODUCTION_HTTPS
SECURE_SSL_REDIRECT = env_bool('SECURE_SSL_REDIRECT', PRODUCTION_HTTPS)
SECURE_HSTS_SECONDS = env_int('SECURE_HSTS_SECONDS', 31536000) if PRODUCTION_HTTPS else 0
SECURE_HSTS_INCLUDE_SUBDOMAINS = env_bool('SECURE_HSTS_INCLUDE_SUBDOMAINS', PRODUCTION_HTTPS)
